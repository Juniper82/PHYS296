...
xBin=np.array([0.023,0.047,0.075,0.12,0.35,0.6]) # Tick marks figure x-axis
Q2Bin=np.array([1.0,10]) # Tick marks figure y-axis
zBin= np.array([0.1, 0.2,0.25,0.3, 0.375, 0.475, 0.6, 0.8, 1.1])
Phperp = np.array([ 0.0, 0.15, 0.25, 0.35, 0.45, 0.6, 0.8, 1.2]) # catagories for z to be ploted indiviualy in each subplot
# binning data
...
fig1=py.figure(figsize=(10, 5),facecolor="gray") # figsize; wxh in inche
